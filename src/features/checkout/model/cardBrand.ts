...
const BRANDS: Record<CardBrand, { name: string; color: string }> = {
...
export function detectCardBrand(number: string | number | null | undefined): CardBrand {
...
export function brandMeta(brand: CardBrand) {
...
export function isCardComplete({ number, name, expiry, cvc }: CardDetails) {
