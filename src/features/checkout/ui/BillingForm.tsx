...
import { totals } from "../model/pricing";
import type { Buyer, Certificate, DurationYears, PackageName } from "../../../types";

type BuyerField = keyof Buyer;
type FieldConfig = [BuyerField, string, string, boolean];
...
export default function BillingForm({ pkg, years, cert, buyer, error, onChange, onBack, onSubmit }: BillingFormProps) {
