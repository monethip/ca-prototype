...
import {
  ...
  formatExpiry,
  isCardComplete,
} from "../model/cardBrand";
import type { Order, Payment } from "../../../types";

const EMPTY = { number: "", name: "", expiry: "", cvc: "" };
const ICONS: CardBrand[] = ["visa", "mastercard", "unionpay"];
...
export default function CardPayment({ pay, order, onConfirm }: CardPaymentProps) {
  ...
  return (
    <div className="card-pay">
      ...
      <div className={"plastic-card brand-" + brand} style={{ "--card-color": meta.color } as CSSProperties}>
