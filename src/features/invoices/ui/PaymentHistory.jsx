...
import { downloadInvoiceHtml, invoiceFromHistory } from "../model/invoice.js";

function DownloadBtn({ r, certs, email }) {
  return (
    <button
...
export default function PaymentHistory({ history, certs, email, onBack }) {
  return (
