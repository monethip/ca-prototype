import { addYears } from "../../../shared/lib/format.js";

export function ageYears(c) {
  return Number(c.baseYears) + Number(c.extraYears || 0);
}

export function validTo(c) {
...
export function isExpiringSoon(c) {
  const d = daysLeft(c);
  return d >= 0 && d <= 60;
}
