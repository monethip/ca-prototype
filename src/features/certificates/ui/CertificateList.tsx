...
import { ageYears, isExpired, remaining, statusTag, validTo } from "../model/status";
...
export default function CertificateList({ certs, email, onReset, onExtend, onRegister }: CertificateListProps) {
  return (
